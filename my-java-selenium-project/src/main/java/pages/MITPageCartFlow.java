...
public class MITPageCartFlow {
    private WebDriver driver;
    private static final Logger logger = LogManager.getLogger(MITPageCartFlow.class);
    ...
    @FindBy(xpath = "//button[contains(text(),'Start CART Flow')]")
    private WebElement startCartFlowButton;

    @FindBy(xpath = "//button[contains(text(),'Populate Default Data')]")
    private WebElement populateDefaultDataButton;

    public MITPageCartFlow(WebDriver driver) {
        this.driver = driver;
        PageFactory.initElements(driver, this);
        logger.info("MITPageCartFlow initialized");
    }
    ...
    public void clickStartCartFlow() {
        logger.info("Clicking Start CART Flow button");
        startCartFlowButton.click();
    }
